...
public class PlotEffectsInventory {
    ...
    public PlotEffectsInventory(Player player, Plot plot) {
        new ChestListInventory.ChestListInventoryBuilder<PlotEffectType>("Efekty na działce", item("Efekt %name%", List.of("Cena: %cost%", "Poziom: %level%/%max_level%")))
                ...
                .withReplacements(effect -> Map.of(
                        ...
                        "%cost%", MoneyTextFormatter.format(plot.getEffects().getPriceForNextLevel(effect)),
